...
public class CommonHelper {
	...
	public static void verifyAndClickOnBackButtonOnProfilePage() {
		...
		BaseTest.utilObj.get().getAssertManager().sAssertEquals(dispayedFlag, true, "Verify Back button is present",
	...
	public static void verifyProfileUserName(String userName) {
		boolean dispayedFlag = mobileActions.isDisplayed(mobileActions.returnByBasedOnPageNameAndObjectName(
				kooDetailScreenPage.profileUserName, "xpath", userName), kooDetailScreenPage.profileUserName_Name);
		BaseTest.utilObj.get().getAssertManager().sAssertEquals(dispayedFlag, true,
				"Verify profile username is present", true, BaseTest.mobileDriver.get(), true);
	}
	...
	public static void clickEnterButton() {
		((RemoteWebDriver) BaseTest.mobileDriver.get()).executeScript("mobile:performEditorAction",
	...
	public static void clickSearchedProfileFromSearchResult(String profileID) {
		mobileActions.click(mobileActions
				.returnByBasedOnPageNameAndObjectName(kooDetailScreenPage.profileIDOnSearchResult, "xpath", profileID),
	...
	public static void clickOnRefreshIconToRefreshComments() {
		mobileActions.click(homeScreenTabPage.refreshButtonOnTrendingKooPage,
				homeScreenTabPage.refreshButtonOnTrendingKooPage_Name);
	}
	 ...
	 * @throws IOException
	 */
	public static void createAndPostMLKKoo(String language, String text, String postButton,
			List<String> languageContentDesc) throws InterruptedException {
		mobileActions.click(kooCreationPage.btn_plus, kooCreationPage.btn_plus_Name);
		mobileActions.sendKeys(kooCreationPage.txt_Message, kooCreationPage.txt_Message_Name, text);
		mobileActions.click(kooCreationPage.btn_Post, kooCreationPage.btn_post_Name);
		if (language.equalsIgnoreCase("English")) {
			...
			for (int i = 0; i < languageContentDesc.size(); i++) {
				mobileActions.swipeUpFindElement(10, mobileActions.returnByBasedOnPageNameAndObjectName(
						kooCreationPage.chkbox_everyone, "xpath", languageContentDesc.get(i)));
				mobileActions.click(
						mobileActions.returnByBasedOnPageNameAndObjectName(kooCreationPage.chkbox_everyone, "xpath",
			...
			mobileActions.waitForVisible(
					mobileActions.returnByBasedOnPageNameAndObjectName(kooCardPage.postButton, "xpath", postButton));
			mobileActions.click(
					mobileActions.returnByBasedOnPageNameAndObjectName(kooCardPage.postButton, "xpath", postButton),
