...
public class KooCardPage {
	...
	public String saveKooRemoveKooText = "//android.widget.TextView[@text='###']";
	public String kooTitle = "//android.widget.TextView[@resource-id='com.koo.app:id/topic_title_textview'][@text='###']";
	...
	public String likeCount_Name = "";
	public String reeKooCount_Name = "";
	public String atTheRatePopUp_Name = "";
	public String addToFavoriteButton_Name = "";
	public String saveKooRemoveKooText_Name = "";
	public String kooTitle_Name = "";
	public String editProfileButton_Name = "Edit button from Profile page";
	public String nameField_Name = "";
	public String handleField_Name = "";
	public String professionField_Name = "";
	public String plusFollowButton_Name = "";
	public String channel_Name = "";
	public String title_Name = "";
	public String image_Name = "";
	public String btn_dots_Name = "";
