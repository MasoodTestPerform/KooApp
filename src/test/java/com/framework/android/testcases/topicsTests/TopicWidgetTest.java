...
public class TopicWidgetTest extends BaseTest {
	...
	@Test(dataProvider = "Languages", dataProviderClass = LanguageDataProvider.class, description = "[TC_054_055] Verify Manage Topics screen in own profile, 'All' & 'Following' tabs should be present in that screen._Verify all the topics in all tab & only followed topics in following tab.", groups = {
			"regression", "Topics" })
