...
public class TopicWidgetTest extends BaseTest {
	...
	public void TC_050_051_verifyTopicTabPage(String language) {
		BaseTest.LOGGER.get().logTestStep(extentTest.get(), "INFO",
				"<b><----Test case execution started for Test: TC_50_51 - Verify Topics tab should have Topics pills with + button, tapping on it or topic name, topic is followed>tapping on arrow button, user goes to Topics Details screen & related topics content should be shown ------><b>",
		...
		try {
			...
			BaseTest.LOGGER.get().logTestStep(extentTest.get(), "INFO",
					"<b><----Test case execution completed for Test:Successfully executed - TC_50_51 - Verify Topics tab should have Topics pills with + button, tapping on it or topic name, topic is followed>tapping on arrow button, user goes to Topics Details screen & related topics content should be shown ------><b>",
